            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Purpose = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CadastralNumber = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Address = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Floors = table.Column<int>(type: "int", nullable: false),
                    TotalArea = table.Column<double>(type: "double", precision: 18, scale: 2, nullable: false),
                    Rooms = table.Column<int>(type: "int", nullable: false),
                    CeilingHeight = table.Column<double>(type: "double", precision: 18, scale: 2, nullable: false),
                    FloorNumber = table.Column<int>(type: "int", nullable: false),
                    HasEncumbrances = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
